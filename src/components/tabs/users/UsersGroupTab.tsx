        ...
        {GROUPS.map((group) => (
          ...
          >
            ...
            <div className="flex gap-2">
              <button className="flex-1 py-2 border border-gray-200 rounded-lg text-xs font-bold text-gray-600 hover:bg-gray-50">
                멤버 관리
              </button>
              <button className="flex-1 py-2 bg-blue-50 rounded-lg text-xs font-bold text-[#3182F6] hover:bg-blue-100">
                일괄 알림
              </button>
            </div>
          </div>
